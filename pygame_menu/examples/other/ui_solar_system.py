...
class SolarSystemApp:
    ...
    def __init__(self) -> None:
        self.surface = create_example_window(
            "Example - Solar System", (1280, 720), flags=pygame.NOFRAME
        )
        ...
        for p in self.planets.keys():
            ...
            button = self.menu.add.button(
                planet.name, submenu, font_size=planet.fontsize
            )
        ...
        self.nebulas = [
            ...
            nebula.copy()
            .set_drawing_offset((500, 50))
            .scale(3, 3)
            .rotate(90)
            .set_alpha(50)
            .pick_channels("b"),
            nebula.copy()
            .set_drawing_offset((50, 100))
            .scale2x()
            .rotate(175)
            .set_alpha(75)
            .pick_channels("r"),
        ...
        for s in self.shooting_stars:
            ...
            c = int(
                ...
                * max(
                    0.1,
                    max(
                        math.sin(0.1 * t + 1.5 * math.pi + flicker),
    ...
    def process_events(
        self, events: list[pygame.event.Event], menu: pygame_menu.Menu
    ) -> None:
        """
