...
from pygame_menu.widgets.widget import (Button, ColorInput, DropSelect,
                                        DropSelectMultiple, Frame, HMargin,
                                        Image, Label, MenuBar, MenuLink,
                                        NoneWidget, ProgressBar, RangeSlider,
                                        ScrollBar, Selector, SurfaceWidget,
                                        Table, TextInput, ToggleSwitch, VFill,
                                        VMargin)
# Widget constants
from pygame_menu.widgets.widget.colorinput import (COLORINPUT_HEX_FORMAT_LOWER,
...
from pygame_menu.widgets.widget.frame import (
    FRAME_DEFAULT_TITLE_BACKGROUND_COLOR, FRAME_TITLE_BUTTON_CLOSE,
    FRAME_TITLE_BUTTON_MAXIMIZE, FRAME_TITLE_BUTTON_MINIMIZE)
from pygame_menu.widgets.widget.menubar import (
    MENUBAR_STYLE_ADAPTIVE, MENUBAR_STYLE_NONE, MENUBAR_STYLE_SIMPLE,
